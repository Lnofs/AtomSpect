...
CIII_scalevars = [1,1]
PlotFunction(CIII_4649,CIII_Plotvars[0],plotwind = [464.5,465.5], SpectrumPlot =[CIII_wav, Normalize(CIIISpec[1])],plottitle="CIII B = 2.24T , 35 degrees" , NormalizeSig = True, NormalizeScale = CIII_scalevars  )
